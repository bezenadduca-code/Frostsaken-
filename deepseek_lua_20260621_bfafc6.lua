-- V1PRWARE - Complete Final Version
...
-- ============================================================
-- NOSFERATU SECTION (FIXED QTE - NO CACHE)
-- ============================================================

local secNosferatu = tabKiller:Section({ Title = "Nosferatu", Opened = true })

-- ===== AUTO QTE (NO CACHE - Always Fresh Search) =====
local qte = {
    on = false,
    speed = 0.03,
}
...
local function qteGetButton()
    ...
    -- Search ALL descendants for ActiveButton
